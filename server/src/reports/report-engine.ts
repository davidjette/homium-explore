...
<div class="container">
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card"><div class="value">${yr10 ? fmtP(yr10.roiCumulative) : '—'}</div><div class="label">${fundLife}-Year ROI</div></div>
...
function generateSummaryReport(data: ReportData): string {
  const fundLife = data.blended.length || 30;
  const yr10 = data.blended[fundLife - 1];
    ...
    <div>
      ...
      <div class="impact-box">
        <div class="impact-grid">
          ...
          <div><div class="big">${yr10 ? fmtP(yr10.roiCumulative) : '—'}</div><div class="lbl">${fundLife}-Year ROI</div></div>
          <div><div class="big">${yr10 ? `$${(yr10.totalEquityCreated / (raise * 0.25)).toFixed(1)}` : '—'}</div><div class="lbl">Wealth per $1 (${fundLife}yr)</div></div>
...
<div class="container">
  ...
  <table>
    <thead><tr><th>HPA</th><th class="text-right">Homeowners</th><th class="text-right">${fundLife}yr ROI</th><th class="text-right">30yr ROI</th><th class="text-right">Equity (${fundLife}yr)</th><th class="text-right">Equity (30yr)</th></tr></thead>
    <tbody>
  ...
  <table>
    <thead><tr><th>Fund Size</th><th class="text-right">Homeowners</th><th class="text-right">${fundLife}yr ROI</th><th class="text-right">30yr ROI</th><th class="text-right">Equity (30yr)</th></tr></thead>
    <tbody>
