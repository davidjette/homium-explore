...
export default function Explorer() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="bg-white pt-[100px] pb-[90px]">
        <Container>
          <div className="max-w-3xl">
            <Label className="text-green mb-4 block">Homium Program Explorer</Label>
            <h1 className="font-heading font-normal text-dark text-[50px] leading-[1.15] max-md:text-[32px]">
              What Could Homeownership<br />Look Like in Your State?
            </h1>
            <Body className="mt-6 text-lg max-w-2xl">
              The gap between what families earn and what homes cost has never been wider.
              Explore the affordability challenge in your market — then see how Homium's
              shared appreciation model can close the gap.
            </Body>
            <a
              href="#explore"
              className="inline-flex items-center gap-2 mt-8 font-body font-bold text-green text-[12px] uppercase tracking-[1.5px] hover:text-greenDark transition-colors"
            >
              Explore Your Market
